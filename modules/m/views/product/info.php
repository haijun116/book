...
StaticService::includeAppJsStatic('js/m/product/info.js', \app\assets\AppAsset::className());
?>
<div style="min-height: 500px;">
    ...
    <div class="pro_express">月销量：<?= UtilService::encode($info['month_count']); ?><b>累计评价：<?= $info['comment_count']; ?></b></div>
    ...
    <div class="pro_fixed clearfix">
        ...
        <?php else: ?>
            <a class="fav" href="javascript:void(0);" data="<?= $info['id']; ?>"><i class="keep_icon"></i><span>收藏</span></a>
        <?php endif; ?>
