    ...
    public function actionIndex()
    {
        ...
        if ($list) {
            foreach ($list as $_item) {
                $tem_cat_info = isset($cat_mapping[$_item['cat_id']]) ? $cat_mapping[$_item['cat_id']] : [];
                $data[] = [
                    'id' => $_item['id'],
                    ...
                    'cat_name' => $tem_cat_info ? UtilService::encode($tem_cat_info['name']) : ''
                ];
            }
        }
