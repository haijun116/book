...
\app\common\services\StaticService::includeAppJsStatic('js/web/account/index.js', app\assets\WebAsset::className());
?>
            ...
            <div class="row m-t p-w-m">
                <div class="form-group">
                    <select name="status" class="form-control inline">
                        <option value="<?= \app\common\services\ConstantMapService::$status_default; ?>">请选择状态</option>
        ...
        <table class="table table-bordered m-t">
            ...
            <?php foreach ($list as $k => $v): ?>
                <tr>
                    ...
                    <td><?= $v['email']; ?></td>
                    <td>
                        <a href="<?= UrlService::buildWebUrl('/account/info', ['id' => $v['uid']]); ?>">
                            <i class="fa fa-eye fa-lg"></i>
                        </a>
                        <a class="m-l" href="<?= UrlService::buildWebUrl('/account/set', ['id' => $v['uid']]); ?>">
                            <i class="fa fa-edit fa-lg"></i>
                        </a>
                        <?php if($v['status']):?>
                            <a class="m-l remove" href="javascript:void(0);" data="<?= $v['uid']; ?>">
                                <i class="fa fa-trash fa-lg"></i>
                            </a>
                        <?php else:?>
                            <a class="m-l recove" href="javascript:void(0);" data="<?= $v['uid']; ?>">
