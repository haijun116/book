<?php
\app\common\services\StaticService::includeAppJsStatic('js/web/brand/images.js', app\assets\WebAsset::className());
?>
        ...
        <table class="table table-bordered m-t">
            ...
            <?php if ($list): ?>
                <?php foreach ($list as $item): ?>
                    <tr>
                        <td>
                            <img src="<?= \app\common\services\UrlService::buildPicUrl('brand', $item['image_key']); ?>"
                                 style="width: 100px;height: 100px;"/>
                        </td>
                        <td>
                            <a target="_blank"
                               href="<?= \app\common\services\UrlService::buildPicUrl('brand', $item['image_key']) ?>">查看大图</a>
                        </td>
                        <td>
                            <a class="m-l remove" href="<?= \app\common\services\UrlService::buildNullUrl(); ?>"
                               data="<?= $item['id']; ?>">
